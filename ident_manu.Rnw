...
grid.arrange(
  arrangeGrob(p1, p2, ncol = 1, heights = c(0.5, 1)),
  left = 'Identifiability', 
  bottom = 'Parameters in set',
  pleg, ncol = 2, widths = c(1, 0.1)
)
