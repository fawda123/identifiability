...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Fri Sep 23 17:24:42 2016 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
%latex.default(totab[, -c(1, 2)], file = "", rowlabel = "Parameter",     caption = cap_val, caption.loc = "top", size = "scriptsize",     label = "tab:heurist1", rowname = parms, rgroup = unique(cats),     n.rgroup = as.numeric(table(cats)), colheads = colnms, rgroupTexCmd = NULL)%
\begin{table}[!tbp]
{\scriptsize
...
%latex.default(totab[, -c(1, 2)], file = "", rowlabel = "Selections by state variable",     caption = cap_val, caption.loc = "top", size = "scriptsize",     label = "tab:heurist2", rowname = sels, rgroup = unique(stts),     n.rgroup = as.numeric(table(stts)), colheads = colnms, rgroupTexCmd = NULL)%
\begin{table}[!tbp]
{\scriptsize
...
~~1&\scriptsize{\textit{mA}}&$1$\textsuperscript{P}&$1$\tabularnewline
~~2&\scriptsize{\textit{nitmax}}&$1$\textsuperscript{OM}&$1.16$\tabularnewline
~~3&\scriptsize{\textit{Zumax}}&$1$\textsuperscript{Z}&$2.9$\tabularnewline
\hline
{Chlorophyll}&&&\tabularnewline
~~1&\scriptsize{\textit{mA}}&$1$\textsuperscript{P}&$1$\tabularnewline
~~2&\scriptsize{\textit{Zumax}}&$1$\textsuperscript{Z}&$1.18$\tabularnewline
\hline
{Dissolved Oxygen}&&&\tabularnewline
~~1&\scriptsize{\textit{umax}}&$1$\textsuperscript{P}&$1$\tabularnewline
~~2&\scriptsize{\textit{ZKa}}&$1$\textsuperscript{Z}&$2.17$\tabularnewline
~~3&\scriptsize{\textit{mA}}&$2$\textsuperscript{P}&$2.31$\tabularnewline
~~4&\scriptsize{\textit{Tref(nospA+nospZ)$_{p1}$}}&$1$\textsuperscript{T}&$2.37$\tabularnewline
~~5&\scriptsize{\textit{ZQn}}&$2$\textsuperscript{Z}&$4.69$\tabularnewline
~~6&\scriptsize{\textit{alpha}}&$3$\textsuperscript{P}&$4.91$\tabularnewline
~~7&\scriptsize{\textit{Zm}}&$3$\textsuperscript{Z}&$6.73$\tabularnewline
~~8&\scriptsize{\textit{Zumax}}&$4$\textsuperscript{Z}&$6.81$\tabularnewline
\hline
{Irradiance}&&&\tabularnewline
~~1&\scriptsize{\textit{ZKa}}&$1$\textsuperscript{Z}&$1$\tabularnewline
~~2&\scriptsize{\textit{umax}}&$1$\textsuperscript{P}&$4.41$\tabularnewline
~~3&\scriptsize{\textit{ZQn}}&$2$\textsuperscript{Z}&$7.54$\tabularnewline
~~4&\scriptsize{\textit{mA}}&$2$\textsuperscript{P}&$8.17$\tabularnewline
~~5&\scriptsize{\textit{KGcdom}}&$1$\textsuperscript{OM}&$9.44$\tabularnewline
~~6&\scriptsize{\textit{alpha}}&$3$\textsuperscript{P}&$9.66$\tabularnewline
~~7&\scriptsize{\textit{Zumax}}&$3$\textsuperscript{Z}&$10.79$\tabularnewline
\hline
...
{OM1}&&&\tabularnewline
~~1&\scriptsize{\textit{mA}}&$1$\textsuperscript{P}&$1$\tabularnewline
~~2&\scriptsize{\textit{Zumax}}&$1$\textsuperscript{Z}&$1.15$\tabularnewline
~~3&\scriptsize{\textit{KG1}}&$1$\textsuperscript{OM}&$3.87$\tabularnewline
\hline
{OM2}&&&\tabularnewline
~~1&\scriptsize{\textit{mA}}&$1$\textsuperscript{P}&$1$\tabularnewline
~~2&\scriptsize{\textit{Tref(nospA+nospZ)$_{p1}$}}&$1$\textsuperscript{T}&$1.05$\tabularnewline
~~3&\scriptsize{\textit{umax}}&$2$\textsuperscript{P}&$2.46$\tabularnewline
~~4&\scriptsize{\textit{Zumax}}&$1$\textsuperscript{Z}&$2.91$\tabularnewline
\hline
{Phosphate}&&&\tabularnewline
~~1&\scriptsize{\textit{ZKa}}&$1$\textsuperscript{Z}&$1$\tabularnewline
~~2&\scriptsize{\textit{umax}}&$1$\textsuperscript{P}&$11.45$\tabularnewline
~~3&\scriptsize{\textit{vmaxP}}&$2$\textsuperscript{P}&$11.48$\tabularnewline
~~4&\scriptsize{\textit{ZQn}}&$2$\textsuperscript{Z}&$13.74$\tabularnewline
\hline
\end{tabular}\end{center}}
...
%latex.default(totab[, -c(1, 2)], file = "", rowlabel = "Selections by state variable",     caption = cap_val, caption.loc = "top", size = "scriptsize",     label = "tab:heurist3", rowname = sels, rgroup = unique(stts),     n.rgroup = as.numeric(table(stts)), colheads = colnms, rgroupTexCmd = NULL)%
\begin{table}[!tbp]
{\scriptsize
...
\hline
{Ammonium}&&&\tabularnewline
~~1&\scriptsize{\textit{mA}}&$1$\textsubscript{P}&$1$\tabularnewline
~~2&\scriptsize{\textit{nitmax}}&$1$\textsubscript{OM}&$1.16$\tabularnewline
~~3&\scriptsize{\textit{Zumax}}&$1$\textsubscript{Z}&$2.9$\tabularnewline
~~4&\scriptsize{\textit{Tref(nospA+nospZ)$_{p1}$}}&$1$\textsubscript{T}&$3.46$\tabularnewline
~~5&\scriptsize{\textit{astar490}}&$1$\textsubscript{O}&$4.25$\tabularnewline
\hline
{Chlorophyll}&&&\tabularnewline
~~1&\scriptsize{\textit{mA}}&$1$\textsubscript{P}&$1$\tabularnewline
~~2&\scriptsize{\textit{Zumax}}&$1$\textsubscript{Z}&$1.18$\tabularnewline
~~3&\scriptsize{\textit{Tref(nospA+nospZ)$_{p1}$}}&$1$\textsubscript{T}&$2.62$\tabularnewline
~~4&\scriptsize{\textit{KGcdom}}&$1$\textsubscript{OM}&$3.24$\tabularnewline
~~5&\scriptsize{\textit{astar490}}&$1$\textsubscript{O}&$5.98$\tabularnewline
\hline
{Dissolved Oxygen}&&&\tabularnewline
~~1&\scriptsize{\textit{umax}}&$1$\textsubscript{P}&$1$\tabularnewline
~~2&\scriptsize{\textit{ZKa}}&$1$\textsubscript{Z}&$2.17$\tabularnewline
~~3&\scriptsize{\textit{Tref(nospA+nospZ)$_{p1}$}}&$1$\textsubscript{T}&$2.29$\tabularnewline
~~4&\scriptsize{\textit{KG1}}&$1$\textsubscript{OM}&$3.85$\tabularnewline
~~5&\scriptsize{\textit{astar490}}&$1$\textsubscript{O}&$3.89$\tabularnewline
~~6&\scriptsize{\textit{mA}}&$2$\textsubscript{P}&$4.42$\tabularnewline
~~7&\scriptsize{\textit{ZQn}}&$2$\textsubscript{Z}&$5.22$\tabularnewline
\hline
{Irradiance}&&&\tabularnewline
~~1&\scriptsize{\textit{ZKa}}&$1$\textsubscript{Z}&$1$\tabularnewline
~~2&\scriptsize{\textit{umax}}&$1$\textsubscript{P}&$4.41$\tabularnewline
~~3&\scriptsize{\textit{KGcdom}}&$1$\textsubscript{OM}&$4.5$\tabularnewline
~~4&\scriptsize{\textit{Tref(nospA+nospZ)$_{p1}$}}&$1$\textsubscript{T}&$4.5$\tabularnewline
~~5&\scriptsize{\textit{astar490}}&$1$\textsubscript{O}&$6.9$\tabularnewline
~~6&\scriptsize{\textit{ZQn}}&$2$\textsubscript{Z}&$10.63$\tabularnewline
~~7&\scriptsize{\textit{mA}}&$2$\textsubscript{P}&$11.21$\tabularnewline
~~8&\scriptsize{\textit{KG1}}&$2$\textsubscript{OM}&$14.65$\tabularnewline
~~9&\scriptsize{\textit{astarOMA}}&$2$\textsubscript{O}&$14.72$\tabularnewline
\hline
{Nitrate}&&&\tabularnewline
~~1&\scriptsize{\textit{umax}}&$1$\textsubscript{P}&$1$\tabularnewline
\hline
{OM1}&&&\tabularnewline
~~1&\scriptsize{\textit{mA}}&$1$\textsubscript{P}&$1$\tabularnewline
~~2&\scriptsize{\textit{Zumax}}&$1$\textsubscript{Z}&$1.15$\tabularnewline
~~3&\scriptsize{\textit{KG1}}&$1$\textsubscript{OM}&$3.87$\tabularnewline
~~4&\scriptsize{\textit{Tref(nospA+nospZ)$_{p1}$}}&$1$\textsubscript{T}&$3.93$\tabularnewline
~~5&\scriptsize{\textit{astar490}}&$1$\textsubscript{O}&$5.81$\tabularnewline
\hline
{OM2}&&&\tabularnewline
~~1&\scriptsize{\textit{mA}}&$1$\textsubscript{P}&$1$\tabularnewline
~~2&\scriptsize{\textit{Tref(nospA+nospZ)$_{p1}$}}&$1$\textsubscript{T}&$1.05$\tabularnewline
~~3&\scriptsize{\textit{Zumax}}&$1$\textsubscript{Z}&$2.61$\tabularnewline
~~4&\scriptsize{\textit{KG2}}&$1$\textsubscript{OM}&$3.39$\tabularnewline
~~5&\scriptsize{\textit{astar490}}&$1$\textsubscript{O}&$4.46$\tabularnewline
~~6&\scriptsize{\textit{umax}}&$2$\textsubscript{P}&$6.02$\tabularnewline
~~7&\scriptsize{\textit{ZKa}}&$2$\textsubscript{Z}&$9.21$\tabularnewline
\hline
{Phosphate}&&&\tabularnewline
~~1&\scriptsize{\textit{ZKa}}&$1$\textsubscript{Z}&$1$\tabularnewline
~~2&\scriptsize{\textit{umax}}&$1$\textsubscript{P}&$11.45$\tabularnewline
~~3&\scriptsize{\textit{Tref(nospA+nospZ)$_{p1}$}}&$1$\textsubscript{T}&$13.71$\tabularnewline
~~4&\scriptsize{\textit{KG1}}&$1$\textsubscript{OM}&$14.64$\tabularnewline
\hline
\end{tabular}\end{center}}
...
%latex.default(totab_all[, -c(1, 2)], file = "", rowlabel = "State variables by parameter category",     caption = cap_val, caption.loc = "top", size = "scriptsize",     label = "tab:inistrchg", rowname = stts, rgroup = unique(cats),     n.rgroup = as.numeric(table(cats)), colheads = colnms, rgroupTexCmd = NULL)%
\begin{table}[!tbp]
{\scriptsize
\caption{Changes in mean sensitivity of state variables by parameter categories to different initial conditions and changes in structural components of the model.  Changes show the difference in average sensitivity from results using the default model setup. Sensitivities are based on average $L1$ (see \cref{l1}) values of the state variables to changes in parameters in each parameter category. Increases in average sensitivity are in bold. Medians and ranges of sensitivity values for the different conditions are shown in \cref{fig:inistrsumm}.\label{tab:inistrchg}} 
\begin{center}
\begin{tabular}{lllll}
\hline\hline
\multicolumn{1}{l}{State variables by parameter category}&\multicolumn{1}{c}{Default sensitivity}&\multicolumn{1}{c}{Initial: April}&\multicolumn{1}{c}{Initial: September}&\multicolumn{1}{c}{Structure: complex}\tabularnewline
\hline
{Optics}&&&&\tabularnewline
