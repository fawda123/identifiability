...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Tue Jun 28 11:58:04 2016 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
%latex.default(totab, file = "", rowlabel = "Parameter", caption = cap.val,     caption.loc = "top", rowname = Parameter, label = "tab:optsens")%
\begin{table}[!tbp]
\caption{Test\label{tab:optsens}} 
\begin{center}
\begin{tabular}{llrll}
\hline\hline
\multicolumn{1}{l}{Parameter}&\multicolumn{1}{c}{Description}&\multicolumn{1}{c}{Value}&\multicolumn{1}{c}{L1}&\multicolumn{1}{c}{L2}\tabularnewline
\hline
\textit{astar490}&Chla specific absorption at 490 nm&$0.0375$&$1.64$&$8.64$\tabularnewline
\textit{astarOMA}&OM\_A specific absorption at 490 nm&$0.1000$&$2.29\times 10^{-2}$&$9.52\times 10^{-2}$\tabularnewline
\textit{astarOMZ}&OM\_Z specific absorption at 490 nm&$0.1000$&$5.65\times 10^{-3}$&$1.42\times 10^{-2}$\tabularnewline
\textit{Kcdom}&AOP, light attenuation due to CDOM&$0.0010$&$3.18\times 10^{-6}$&$1.09\times 10^{-5}$\tabularnewline
\hline
