...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Wed Jun 29 14:50:46 2016 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
\caption{Sensitivity of \ac{do} to parameter changes.  Each solid line shows the parameter within each category that had the largest effect on \ac{do} with a 50\% change from the default value.  The dashed line shows \ac{do} holding all parameters at their default values.  The bottom plot shows the estimated \ac{do} as a difference from the default.}\label{fig:sensplo}
\end{figure}
