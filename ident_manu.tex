...
\tnotetext[mytitlenote]{Version: Tue Aug 1 16:09:48 2017 -0500, \href{https://github.com/fawda123/identifiability/commit/c8fc63e4d9d637ede500474a4806a69c13b5c16a}{c8fc63e4d9d637ede500474a4806a69c13b5c16a}\newline Acronyms: \acfi{chla}; \acfi{cgem}; \acfi{do}; \acfi{dom}; \acfi{gom}; \acfi{lcs}; \acfi{marb}; \acfi{pom}; \acfi{rmse}; \acfi{zerod}}
...
~~Chla specific absorption at 490 nm&\textit{astar490}&$0.04$&$7.51\times 10^{-4}$\tabularnewline
~~OMZ specific absorption at 490 nm&\textit{astarOMZ}&$0.1$&$4.92\times 10^{-5}$\tabularnewline
~~OMA specific absorption at 490 nm&\textit{astarOMA}&$0.1$&$4.39\times 10^{-5}$\tabularnewline
\hline
{\bfseries Temperature}&&&\tabularnewline
~~Optimum temperature for growth(C)&\textit{Tref(nospA+nospZ)$_{p1}$}&$22$&$0.02$\tabularnewline
\hline
{\bfseries Phytoplankton}&&&\tabularnewline
~~maximum growth rate&\textit{umax}&$0.41$&$0.05$\tabularnewline
~~mortality coefficient&\textit{mA}&$0.1$&$0.02$\tabularnewline
~~initial slope of the photosynthesis-irradiance relationship&\textit{alpha}&$8.42\times 10^{-17}$&$0.02$\tabularnewline
~~edibility vector for Z1&\textit{ediblevector(Z1)}&$0.25$&$0.02$\tabularnewline
~~phytoplankton carbon/cell&\textit{Qc}&$1.35\times 10^{-6}$&$0.01$\tabularnewline
~~phytoplankton growth respiration coefficient&\textit{respg}&$0.1$&$8.36\times 10^{-3}$\tabularnewline
~~N-uptake rate measured at umax&\textit{vmaxN}&$4.1\times 10^{-8}$&$8.12\times 10^{-3}$\tabularnewline
~~phytoplankton basal respiration coefficient&\textit{respb}&$0.02$&$6.94\times 10^{-3}$\tabularnewline
~~Phytoplankton threshold for grazing, is multiplied by VOLcell&\textit{Athresh}&$1.72\times 10^{8}$&$4.57\times 10^{-3}$\tabularnewline
