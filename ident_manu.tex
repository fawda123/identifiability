...
% ident all states
%latex.default(identall1, file = "", rowlabel = "Parameter description",     caption = cap_val, caption.loc = "top", size = "footnotesize",     label = "tab:identall1", rowname = descrip, colheads = colnms,     rgroupTexCmd = NULL)%
\begin{table}[!tbp]
{\footnotesize
