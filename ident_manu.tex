...
\tnotetext[mytitlenote]{Version: Sun Mar 26 14:18:02 2017 -0500, \href{https://github.com/fawda123/identifiability/commit/4a9eb06d6e3839b6a43aa6e1e4dfe01a06a56524}{4a9eb06d6e3839b6a43aa6e1e4dfe01a06a56524}}
...
%latex.default(totab[, -1], file = "", rowlabel = "Selection heuristic",     caption = cap_val, caption.loc = "top", size = "scriptsize",     label = "tab:calib", rowname = totab$heurist, rgroup = c("1",         "2", "3"), n.rgroup = c(5, 1, 1), colheads = colnms)%
\begin{table}[!tbp]
{\scriptsize
