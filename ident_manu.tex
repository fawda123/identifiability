...
\tnotetext[mytitlenote]{Version: Sun Mar 26 15:32:37 2017 -0500, \href{https://github.com/fawda123/identifiability/commit/b41a6df79d21b187457db88f058313b9b430416a}{b41a6df79d21b187457db88f058313b9b430416a}}
...
Calibration of parameter values for each of the seven selection heuristics produced model output that varied in precision and computational effort to identify optimal values (\cref{tab:calib}).  The seven evaluated subsets were those for \ac{do} in each of the four categories of parameters in \cref{tab:heurist1}, including the single parameter for temperature.  The subsets in \cref{tab:heurist2,tab:heurist3} for the parameters selected independent of category and equally within each category were also evaluated.  As expected, the number of required iterations to minimize \ac{rmse} of observed \ac{do} and model output varied in proportion to the number of parameters in a subset.  For example, only six iterations were required to optimize the single parameter selected for the temperature category, whereas 850 iterations were required for the eight parameters selected independent of category.  A slight positive assocation between collinearity and number of iterations was also observed, such that computational effort  to identify optimal values for a parameter set inreased with lower identifiability (higher $\gamma$).  Of the seven paramter subsets, selection independent of category and equally within each category produced the lowest \ac{rmse} values ($67.05$, $67.67$, respectively), whereas the optimal values for paramters in the Optics category had the lowest reduction in \ac{rmse} ($72.14$).  Lower \ac{rmse} was associated with higher average sensitivity of a parameter subset.  Parameters selected only in the optics category had the highest \ac{rmse} and lowest average L1 ($2.81\times 10^{-4}$), whereas parameters selected independent of category had the lowest \ac{rmse} and highest average L1 ($0.03$, \cref{tab:calib}). 
...
~~Optics&$3.87$&$3$&$2.81\times 10^{-4}$&$14$&$72.14$\tabularnewline
~~Organic Matter&$8.61$&$5$&$3.18\times 10^{-3}$&$154$&$68.7$\tabularnewline
~~Phytoplankton&$3.97$&$7$&$0.02$&$270$&$68.72$\tabularnewline
~~Temperature&$1$&$1$&$0.02$&$6$&$71.76$\tabularnewline
~~Zooplankton&$5.2$&$4$&$0.03$&$99$&$71.22$\tabularnewline
\hline
{\bfseries 2}&&&&&\tabularnewline
~~Independent of category&$6.81$&$8$&$0.03$&$850$&$67.05$\tabularnewline
\hline
{\bfseries 3}&&&&&\tabularnewline
~~Equally within category&$5.22$&$7$&$0.03$&$690$&$67.67$\tabularnewline
\hline
\end{tabular}\end{center}}
\footnotesize *Starting \ac{rmse} $= 72.14$\end{table}
