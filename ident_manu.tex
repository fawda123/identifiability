...
\author{
  ...
  \vspace{1in} 
  \\ Version Date:   Tue Aug 23 17:18:33 2016 -0500
	}
\date{}
\maketitle
\end{singlespace}
...
\caption[Sensitivity values (L1, \cref{l1}) for local analyses of all state variables]{Sensitivity values (L1, \cref{l1}) for local analyses of all state variables. Parameters are grouped by category: optics, organic matter, phytoplankton, zooplankton, temperature, and zoplankton.}\label{fig:sensalltile}
\end{figure}
